      ...
      <nav class="side-nav side-nav--simple">
        <ul>
          ...
          <template v-for="(menu, menuKey) in formattedMenu">
            <li
              v-if="menu == 'devider' && menu.showMenu"
              :key="menu + menuKey"
              class="side-nav__devider my-6"
            ></li>
            <li  v-if="menu != 'devider' && menu.showMenu" :key="`${menu + menuKey}`">
              <Tippy
                tag="a"
                :content="menu.title"
                :options="{
...
import LayoutSwitcher from "../components/layout-switcher/Main.vue";
...
const simpleMenu = computed(() => nestedMenu(menuStore.menu, route));
